...
const EventDetails = () => {
	...
	return (
		<div className='min-h-screen bg-gray-900'>
							...
							<div className='text-center py-4'>
								...
								{event.userRegistration && (
									<div className='mt-4 p-4 bg-gray-800 rounded-xl border border-gray-700'>
										<p className='text-gray-400 text-xs mb-1 uppercase tracking-wide'>Ticket ID</p>
										<button
											onClick={() => setShowQRModal(true)}
											className='font-mono text-primary-400 hover:text-primary-300 underline text-sm break-all cursor-pointer transition'
											title='Click to view QR code'
										>
											{event.userRegistration.ticketId}
										</button>
										<p className='text-gray-500 text-xs mt-1'>Click to view QR code</p>
									</div>
								)}
			...
			{/* QR Code Modal */}
			{showQRModal && event.userRegistration && (
				<div
				...
				>
					...
					>
						<h3 className='text-white font-bold text-lg mb-1'>Your Ticket</h3>
						<p className='text-gray-400 text-sm mb-4'>{event.name}</p>

						{event.userRegistration.qrCode ? (
							<img
								src={event.userRegistration.qrCode}
								alt='Ticket QR Code'
								className='mx-auto w-56 h-56 rounded-xl border border-gray-700'
							/>
						) : (
							<div className='mx-auto w-56 h-56 bg-gray-800 rounded-xl flex items-center justify-center'>
								<p className='text-gray-500 text-sm'>QR not available</p>
							</div>
						)}

						<p className='font-mono text-primary-400 text-sm mt-4 break-all'>{event.userRegistration.ticketId}</p>

						<button
							onClick={() => setShowQRModal(false)}
							className='mt-6 px-6 py-2 bg-gray-700 hover:bg-gray-600 text-white rounded-lg text-sm transition'
						>
							Close
						</button>
					</div>
